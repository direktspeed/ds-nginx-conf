...
function createConfItem(file, context, node) {
  ...
  var newContext = {
    ...
    _add: function(name, value, children, comments, options) {
      ...
      file.emit('added', createConfItem(file, newContext, {
        name: name,
        value: value,
        children: children,
        comments: comments,
    ...
    _getString: function(depth) {
      ...
      var properties = Object.keys(this).filter(function(key) {
...
class NginxConfFile extends EventEmitter {
  ...
  static createn(file, options, callback) {
  ...
  static createFromSourcen(source, options, callback) {
    if (typeof(options) === 'function') {
      callback = options;
      options = null;
    }
